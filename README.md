...
| `SMTP_HOST/PORT/USER/PASS/FROM` | — | ส่ง OTP รีเซ็ตรหัสทางอีเมล — เว้นว่าง = OTP พิมพ์ลง console (ใช้เฉพาะ dev) |
...
| POST | `/:id/start` `/:id/close` `/:id/cancel` `/:id/reopen` | เริ่มบริการ / ปิด / ยกเลิก / เปิดใหม่ |
