...
export const api = {
  ...
  /**
   * ของค้างทั้งระบบสำหรับกระดิ่งบนแถบเมนู — คืน { total, groups }
   * groups.payroll มาเฉพาะผู้จัดการ (server ตัดออกให้ตำแหน่งอื่น ดู notify/alerts.js)
   */
  alerts: () => request('/notify/alerts'),
  /**
