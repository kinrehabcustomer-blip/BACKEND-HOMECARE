...
export default function NotificationBell() {
  ...
  /* โหลดตอนเปิดแอป แล้วตั้งเวลาดึงซ้ำ · ดึงใหม่ตอนเปลี่ยนหน้าด้วย เพราะคนมักเปลี่ยนหน้า
     ...
     ทั้งสองเรื่องต้องอยู่ใน effect ก้อนเดียว ห้ามแยก — แยกแล้วตอน mount มันทำงานทั้งคู่
     กลายเป็นยิง /notify/alerts สองครั้งทุกครั้งที่เปิดแอป ซึ่งเส้นนี้ไม่ใช่เส้นถูก
     (นับทั้งระบบสิบกว่าตาราง วัดได้ ~270 ms สำหรับผู้จัดการ)
     ผลพลอยได้: นาฬิกาถูกตั้งใหม่ทุกครั้งที่เปลี่ยนหน้า จึงนับจากครั้งที่ดึงล่าสุดจริงๆ */
  useEffect(() => {
