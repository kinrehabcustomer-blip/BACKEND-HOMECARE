 ...
 *
 * คะแนนรวมของแต่ละคน = ค่าเฉลี่ยของ "ค่าเฉลี่ยทุกข้อในใบนั้น" ของทุกใบ (คิดฝั่ง server)
    ...
    <PageRefresh onRefresh={load} busy={loading}>
      ...
      {rows.length === 0 ? (
        <div className="empty-state">
          <p>ยังไม่มีพนักงานสายบำบัดในระบบ</p>
          <p className="muted">
            แบบประเมินนี้เปิดใช้กับนักกายภาพบำบัด นักกิจกรรมบำบัด และนักแก้ไขการพูด
          </p>
        </div>
      ) : (
