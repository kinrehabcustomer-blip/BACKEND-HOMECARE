...
/** ลบถาวรได้เฉพาะร่าง — ใบที่ออกเลขไปแล้วต้องใช้ "ยกเลิก" เพื่อให้เลขเอกสารเรียงต่อเนื่อง ไม่ข้าม */
invoicesRouter.delete(
  '/:id',
  asyncRoute(async (req, res) => {
    if (req.invoice.status !== 'draft') {
      throw new ApiError(409, 'ลบได้เฉพาะใบร่าง — ใบที่ออกแล้วให้ใช้ "ยกเลิก" แทน (เลขเอกสารต้องไม่ข้าม)');
    }
